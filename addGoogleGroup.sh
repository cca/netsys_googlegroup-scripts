...
echo Usage: .\/addGoogleGroup.sh \<group\> \<manager\>
	...
	$GAM update group $GROUP  who_can_post_message managers_can_post
	...
	$GAM update group $GROUP  who_can_view_membership all_managers_can_view
	$GAM update group $GROUP  who_can_leave_group ALL_MANAGERS_CAN_LEAVE
	$GAM update group $GROUP  include_in_global_address_list false
